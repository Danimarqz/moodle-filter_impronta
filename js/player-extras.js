...
window.ImprontaPlayerExtras = function(cfg) {
  ...
  function waitForPlayer() {
    ...
    // Pasar el elemento evita que Video.js interprete puntos del nombre de clase
    // (p. ej. SERGAS1.1) como sintaxis de selector CSS.
    var element = document.getElementById(targetId);
    var player = element && typeof videojs === 'function' ? videojs(element) :
      (videojs.getPlayer ? videojs.getPlayer(targetId) : null);
  ...
  function init(player) {
    ...
    // (sin límite, puede provocar reintentos prolongados contra un segmento
