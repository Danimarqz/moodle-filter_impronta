...
// En horizontal la capa fija sale cortada justo en el borde de la
...
(function(global) {
  ...
  function encajar(player, wm) {
    ...
    function medir() {
      ...
      // watermark salía a un tamaño enorme antes del play (bug de escalado: mancha
