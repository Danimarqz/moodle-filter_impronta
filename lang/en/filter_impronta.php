...
/**
 * English language strings for the Impronta filter.
...
// Privacy API: data sent to the external Impronta service.
$string['privacy:metadata:impronta'] = 'Impronta receives playback authorisation, watermark and analytics data to control access to videos, display learner-specific watermarks and detect abnormal downloads.';
$string['privacy:metadata:impronta:subject'] = 'A pseudonymous identifier derived from the Moodle user ID is sent to associate playback, sessions and analytics with the same learner without exposing the Moodle ID directly.';
$string['privacy:metadata:impronta:watermarklabel'] = 'The configured watermark may contain the learner name, email, username, ID number, city, country, institution, department, phone numbers or custom profile-field values.';
$string['privacy:metadata:impronta:ip'] = 'The learner IP address is sent to support access auditing and abuse detection.';
$string['privacy:metadata:impronta:videopath'] = 'The logical video or class path is sent to authorise playback and associate analytics with the requested class.';
$string['privacy:metadata:impronta:authorizationgroupid'] = 'The optional authorisation-group identifier is sent to enforce group-specific playback access.';
$string['privacy:metadata:impronta:sessionid'] = 'The playback session identifier is sent to renew and correlate an active playback session.';
$string['privacy:metadata:impronta:playbackid'] = 'The playback instance identifier is sent to keep heartbeats and analytics tied to one player instance.';
$string['privacy:metadata:impronta:eventtype'] = 'The playback event type is sent for analytics and abuse detection.';
$string['privacy:metadata:impronta:eventpositionseconds'] = 'The playback position in seconds is sent for analytics.';
$string['privacy:metadata:impronta:eventtimestamp'] = 'The event timestamp is sent to order playback activity.';
$string['privacy:metadata:impronta:eventmode'] = 'The authorisation mode is sent to distinguish playback flows.';
$string['privacy:metadata:impronta:eventclient'] = 'The client type is sent to distinguish web and app playback.';
$string['privacy:metadata:impronta:eventflushreason'] = 'The reason a batch was flushed is sent for analytics and operational diagnostics.';
$string['privacy:metadata:impronta:watchedseconds'] = 'The watched duration in seconds is sent with playback heartbeats for analytics and billing.';
$string['privacy:metadata:impronta:batchid'] = 'The optional heartbeat batch identifier is sent to deduplicate playback accounting.';
