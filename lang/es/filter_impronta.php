...
/**
 * Spanish language strings for the Impronta filter.
...
$string['bindipdesc'] = 'Vincula a la IP los tokens del navegador. No afecta a la app móvil, que puede cambiar de Wi-Fi a datos.';
...
// API de privacidad: datos enviados al servicio externo Impronta.
$string['privacy:metadata:impronta'] = 'Impronta recibe datos de autorización de reproducción, marca de agua y analítica para controlar el acceso a vídeos, mostrar marcas personalizadas y detectar descargas anómalas.';
$string['privacy:metadata:impronta:subject'] = 'Se envía un identificador seudónimo derivado del usuario Moodle para asociar reproducción, sesiones y analítica al mismo alumno sin exponer directamente su ID Moodle.';
$string['privacy:metadata:impronta:watermarklabel'] = 'La marca configurada puede contener nombre, correo, usuario, número de identificación, ciudad, país, institución, departamento, teléfonos o campos de perfil personalizados.';
$string['privacy:metadata:impronta:ip'] = 'Se envía la IP del alumno para auditoría de acceso y detección de abusos.';
$string['privacy:metadata:impronta:videopath'] = 'Se envía la ruta lógica del vídeo o clase para autorizar la reproducción y asociar la analítica a la clase solicitada.';
$string['privacy:metadata:impronta:authorizationgroupid'] = 'El identificador opcional del grupo de autorización se envía para aplicar el acceso específico del grupo.';
$string['privacy:metadata:impronta:sessionid'] = 'Se envía el identificador de sesión de reproducción para renovar y correlacionar una sesión activa.';
$string['privacy:metadata:impronta:playbackid'] = 'Se envía el identificador de la instancia del reproductor para mantener ligados los latidos y la analítica a una reproducción.';
$string['privacy:metadata:impronta:eventtype'] = 'Se envía el tipo de evento de reproducción para analítica y detección de abusos.';
$string['privacy:metadata:impronta:eventpositionseconds'] = 'Se envía la posición de reproducción en segundos para analítica.';
$string['privacy:metadata:impronta:eventtimestamp'] = 'Se envía la marca temporal del evento para ordenar la actividad de reproducción.';
$string['privacy:metadata:impronta:eventmode'] = 'Se envía el modo de autorización para distinguir los flujos de reproducción.';
$string['privacy:metadata:impronta:eventclient'] = 'Se envía el tipo de cliente para distinguir la reproducción web y de app.';
$string['privacy:metadata:impronta:eventflushreason'] = 'Se envía el motivo del vaciado del lote para analítica y diagnóstico operativo.';
$string['privacy:metadata:impronta:watchedseconds'] = 'Se envía la duración vista en segundos con los latidos para analítica y facturación.';
$string['privacy:metadata:impronta:batchid'] = 'Se envía el identificador opcional del lote de latidos para deduplicar la contabilización.';
